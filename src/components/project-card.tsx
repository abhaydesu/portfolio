  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center md:justify-between w-full mt-3 px-1">
        <h2 className="font-medium tracking-tight text-neutral-600 dark:text-neutral-300 text-center md:text-left">
          {project.title}
        </h2>
      ...
      <div className="flex flex-wrap justify-center md:justify-start mt-2">
        {project.tech.map((tech, i) => (
          <motion.span
            ...
            viewport={{ once: true }}
            className="px-2 py-0.5 rounded-full text-xs font-medium bg-neutral-100 dark:bg-neutral-800/70 
