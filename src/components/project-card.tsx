...
<motion.div
  ...
  viewport={{ once: true }}
  className="group relative mb-4 flex flex-col items-center md:items-start rounded-xl border border-neutral-200 transition-all duration-400 dark:border-neutral-800 hover:border-neutral-400 hover:dark:border-neutral-600 md:py-2 py-8 px-2 "
>
  <Image
    src={project.src}
    alt={project.title}
